...
public class TweetHashtags extends TableImpl<TweetHashtagsRecord> {
    ...
    public model.tables.Hashtags hashtags() {
        if (_hashtags == null)
            _hashtags = new model.tables.Hashtags(this, Keys.TWEET_HASHTAGS__TWEET_HASHTAGS_HASHTAG_ID_FKEY);
    ...
    public model.tables.Tweets tweets() {
        if (_tweets == null)
            _tweets = new model.tables.Tweets(this, Keys.TWEET_HASHTAGS__TWEET_HASHTAGS_TWEET_ID_FKEY);
