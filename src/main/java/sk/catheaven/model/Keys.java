...
public class Keys {
    ...
    public static final UniqueKey<TweetConspiracyTheoryRecord> TWEET_CONSPIRACY_THEORY_PKEY = Internal.createUniqueKey(TweetConspiracyTheory.TWEET_CONSPIRACY_THEORY, DSL.name("tweet_conspiracy_theory_pkey"), new TableField[] { TweetConspiracyTheory.TWEET_CONSPIRACY_THEORY.ID }, true);
